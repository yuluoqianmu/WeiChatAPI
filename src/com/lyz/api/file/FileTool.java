...
//	private OutputStream os = null;
	...
	/**
	 * 记录日志，每次记录一条日志都需要打开和关闭文件
	 * @param content
	 * @param fileDir
	 * @param fileName
	 */
	public static void logToFile(String content, String fileDir, String fileName){
        ...
        try {
            ...
            writer.write(BaseTypeUtil.getStrDateTime(System.currentTimeMillis(), "yyyy-MM-dd HH:mm:ss\t")+content+"\n");
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            if (writer != null) {
