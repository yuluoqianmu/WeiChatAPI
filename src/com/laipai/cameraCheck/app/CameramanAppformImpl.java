 ...
 * @time:2015-1-6 下午5:56:20
 */
@NotLogin
@Service("CameramanAppformImpl")
public class CameramanAppformImpl implements RequestExecutor {
	...
	public Object execute(BaseRequestParameters parameters,
		...
		JSONArray styleIds=JSONTools.getJSONArray(json, "styleIds");
		if(userId==null||
				realName==null||
				userGender==null||
				cityId==null||
	  ...
	  //3张作品
	    //String Ids = json.getString("StyleIds");
