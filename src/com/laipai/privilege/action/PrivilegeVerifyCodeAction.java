...
@Service("privilegeVerifyCodeAction")
public class PrivilegeVerifyCodeAction extends BaseAction{
	...
	public String verifyCode()
	{
		...
		System.out.println("==============================");
		System.out.println("$ ===================== verifyCodeLength = " + LaipaiConstants.getVerifyCodeLength());
		try
		{
	        ...
	        //	       取随机产生的认证码(6位数字)  
	        String sRand="";  
	        for (int i=0;i<LaipaiConstants.getVerifyCodeLength();i++){  
	        ...
	        System.out.println("$$ ------------------------- random  = " + sRand);
