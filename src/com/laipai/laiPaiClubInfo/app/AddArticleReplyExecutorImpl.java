 ...
 * @author zhh
 */
@Service("AddArticleReplyExecutorImpl")
public class AddArticleReplyExecutorImpl implements RequestExecutor {
...
//				map.put("headImage", ImgUtil.getImgUrl(comment.getLpUser().getHeadImage()));
//				}else{
//				map.put("headImage", comment.getLpUser());	
//				}
