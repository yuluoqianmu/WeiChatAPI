...
public class Util {
    ...
    public static String getXMLFromObject(Object obj, Class tClass){
    	
    	 XStream xStreamForResponseData = new XStream(new XppDriver(new XmlFriendlyNameCoder(
    			 "_-", "_")));
    	 xStreamForResponseData.alias("xml", tClass);
    	 return xStreamForResponseData.toXML(obj);
    }
    ...
    public static void main(String args[]){
    	...
    	System.out.println(Util.getXMLFromObject(resp, resp.getClass()));
    }
