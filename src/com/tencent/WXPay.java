...
public class WXPay {
     ...
     * @throws Exception
     */
    public static String requestPrePayService(PrePayReqData data) throws Exception{
    	
    	return new PrePayService().request(data);
    }
    ...
    public static PrePayRespData getPrePayRespData(){
    	
    	try {
			/*组装数据*/
			PrePayReqData data = new PrePayReqData(Configure.getAppid(), Configure.getMchid(), "1234", null, "测试", "13", 1, Configure.getIP(), "http://test.ilaipai.com/LaiPai/alipay", "APP");
			...
			/*调用服务*/
			String req = WXPay.requestPrePayService(data);
			
			System.out.println(req);
			
			PrePayRespData returnData = (PrePayRespData)Util.getObjectFromXML(req, PrePayRespData.class);
...
//    	try {
//			/*组装数据*/
//			PrePayReqData data = new PrePayReqData(Configure.getAppid(), Configure.getMchid(), System.currentTimeMillis()+"", null, "测试支付", "11", 1, Configure.getIP(), "http://test.ilaipai.com/LaiPai/alipay", "APP");
//			String sign = Signature.getSign(data);
//			data.setSign(sign);
//			
//			/*调用服务*/
...
//			PrePayRespData returnData = (PrePayRespData)Util.getObjectFromXML(req, PrePayRespData.class);
			...
			System.out.println(returnData.getReturn_code());
			
			System.out.println(returnData.getResult_code());
			
			System.out.println(returnData.getPrepay_id());
