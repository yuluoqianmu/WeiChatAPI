...
<script type="text/javascript"
  ...
  <body>
    ...
    <ul class="forminfo">
    <form id="editForm" name="editForm" method="post" action="orderAction_sendMessage.action" >
    	<input type="hidden" id="orderId" name="orderId" value="<s:property  value='#request.order.orderId'/>" />
    	
		<li><label style="width:800px;">内容编辑：</label></li>
		<li>
			<textarea class="dfinput" name="messageTemplate" id="messageTemplate" style="width:60%;height: 60%" rows="7" ><s:property value="#request.messageTemplate"/></textarea>
		</li>
